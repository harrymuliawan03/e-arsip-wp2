...
<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
    <ul class="nav navbar-nav">
        <li class="<?= uri_string(3) === 'home' ? 'active' : '' ?>"><a href="<?= base_url('home') ?>">Home</a></li>
        <li class="<?= uri_string(3) === 'kategori' ? 'active' : '' ?>"><a
                href="<?= base_url('kategori') ?>">Category</a>
        </li>
        <li class="<?= uri_string(3) === 'dep' ? 'active' : '' ?>"><a href="<?= base_url('dep') ?>">Departement</a>
        </li>
        <li class="<?= uri_string(3) === 'arsip' ? 'active' : '' ?>"><a href="<?= base_url('arsip') ?>">Document</a>
        </li>
        <li class="<?= uri_string(3) === 'user' ? 'active' : '' ?>"><a href="<?= base_url('user') ?>">Admin</a>
        </li>
    </ul>
</div>
<!-- /.navbar-collapse -->
